...
for s = 1:Nsubjects
     ...
     %react1 = [react1; rt1(offset:endoffset)];
     %react1avg = [react1avg; mean(react1,2);
     %react2 = [react2; rt2(offset:endoffset)];
...
for iter = 1:10;   % run 1 times from random initial conditions, to get best fit
    for i = 1:Nsubjects;
        fprintf('%d...',i)
